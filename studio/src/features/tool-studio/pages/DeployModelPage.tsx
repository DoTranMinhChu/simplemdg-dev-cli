...
import type { TDeployModelResult, TDeployTarget, TDiscoveredObjectType, TGitLabGroup, TObjectTypeMode, TCdsVersion } from "../api/tool-studio-api-client";
...
function CreateDeployTargetForm({ onCreated }: { onCreated: (target: TDeployTarget) => void }): React.ReactElement {
